<template>
  <div class="login-body">
      ...
      <el-form class="login-register" :model="formData" :rules="rules" ref="formDataRef">
        ...
        <div v-if="opType == 0 || opType == 2">
          ...
          <el-form-item prop="registerPassword">
            <el-input type="password" size="large" placeholder="请输入密码" v-model.trim="formData.registerPassword" show-password>
              <template #prefix>
                <span class="iconfont icon-password"></span>
              </template>
            </el-input>
          ...
          <el-form-item prop="reRegisterPassword">
            <el-input type="password" size="large" placeholder="请再次输入密码" v-model.trim="formData.reRegisterPassword" show-password>
              <template #prefix>
                <span class="iconfont icon-password"></span>
              </template>
            </el-input>
    ...
    <!--发送邮箱验证码-->
    <Dialog :show="dialogConfig4SendMailCode.show" :title="dialogConfig4SendMailCode.title" :buttons="dialogConfig4SendMailCode.buttons" width="500px" :showCancel="false" @close="dialogConfig4SendMailCode.show = false">
...
const formData = ref({
  email: 'example@example.com', // 设置邮箱的默认值
  password: 'your_default_password' // 设置密码的默认值
});
...
// 在组件加载时设置表单的初始值
    onMounted(() => {
      ...
      if (formDataRef.value) {
        formDataRef.value.formData = formData.value;
      }
    });
